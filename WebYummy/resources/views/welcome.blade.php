...
<body>
    <header class="header">
        ...
        <nav class="auth-links">
            ...
            <a href="{{ route('Registrosolicitud') }}" class="text-white auth-link">{{ __('Solicitud de registro de restaurantes') }}</a>
        </nav>
                        ...
                        <div class="slide-wrapper">
                            <div class="slide-content">
                                <div class="promo-content">
                                    ...
                                    <a href="/promo" class="cta-button">Usar Código: WMVYL</a>
                                </div>
                                <div class="promo-image">
                                    <img src="/images/promotion1.jpeg" alt="Promo 1" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slide-wrapper">
                            <div class="slide-content">
                                ...
                                <div class="promo-image">
                                    <img src="/images/promotion2.png" alt="Promo 2" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="slide-wrapper">
                            <div class="slide-content">
                                ...
                                <div class="promo-image">
                                    <img src="/images/pizza.jpg" alt="Promo 3" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="featured-categories">
            ...
            <div class="categories-grid">
                <div class="category-card">
                    <img src="/images/salad.jpg" alt="Categoría 1" />
                    <h3>Vinos Tintos</h3>
                </div>
                <div class="category-card">
                    <img src="/images/tacos.jpg" alt="Categoría 2" />
                    <h3>Vinos Blancos</h3>
                </div>
                <div class="category-card">
                    <img src="/images/comida_banner.jpg" alt="Categoría 3" />
                    <h3>Licor</h3>
                </div>
            </div>
        </section>
        ...
        <section class="promotions">
            ...
            <div class="promotions-grid">
                <div class="promotion-card">
                    <img src="/images/promotion1.jpeg" alt="Promoción 1" />
                ...
                <div class="promotion-card">
                    <img src="/images/promotion2.png" alt="Promoción 2" />
                    <div class="promotion-info">
                ...
                <div class="promotion-card">
                    <img src="/images/pizza.jpg" alt="Promoción 3" />
                    <div class="promotion-info">
